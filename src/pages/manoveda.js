  ...
  return (
    <div className='manovedaPageWrap'> 
        <header className='container'>
          ...
          <Link href="https://wa.me/91717729979" className='blkBtn' rel="noopener noreferrer" target="_blank" 
          >Contact us</Link>
        </header>
        <main>
          ...
          <div className='footer'>
            <div className='footerWarp container'>
              <div className='footerSecLeft'>
                ...
                <Link href="tel:+91717729979"  className='blkBtn talk'>Talk to sales</Link>
              </div>
              <div className='footerSecRight'>
                ...
                <div className='socialbock'>
                  ...
                  <div className='socialbockInner'>
                    <Link href="https://www.facebook.com/share/FcXT6D2Y8huJVJvW/?mibextid=LQQJ4d">
                    ...
                    <Link href="https://www.instagram.com/intouchllp?igsh=c3M0OXM0dTljOG9o&utm_source=qr">
                    ...
                    <Link href="https://www.youtube.com/@intouch-podcast">

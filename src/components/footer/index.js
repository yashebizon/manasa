...
import homeIcon from '../../images/25.svg';
import guideIcon from '../../images/26.svg';
import chatIcon from '../../images/27.svg';
import miniGuideIcon from '../../images/28.svg';
    ...
    return (
        <footer className='footer'>
          <ul>
            <li>
              <Link href="#">
                <Image src={homeIcon} alt="wellness Activity" />
            ...
            <li>
              <Link href="#">
                <Image src={guideIcon} alt="wellness Activity" />
            ...
            <li>
              <Link href="#">
                <Image src={chatIcon} alt="wellness Activity" />
            ...
            <li>
              <Link href="#">
              <Image src={miniGuideIcon} alt="wellness Activity" />
